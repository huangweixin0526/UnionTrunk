...
import com.android.weixin.unionlotto.utils.FileUtil;
...
public class APPConfig {
	...
	public static final String DATABASES_PATH = FileUtil.getStorageDirectory().getPath() + File.separatorChar + APP_ROOT_DIR_NAME;
