...
public class TwoDataPreviewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.two_data_item_layout, parent, false);
	...
	private void setPreviewData(int position, UnionLotteryInfo unionLotteryInfo, ViewHoloder viewHoloder) {
		...
		if (unionLotteryNumbers != null) {
			viewHoloder.previewViewHoloder.two_red_num_one_tv.setText(String.valueOf(unionLotteryNumbers.getRedNumOne()));
			viewHoloder.previewViewHoloder.two_red_num_two_tv.setText(String.valueOf(unionLotteryNumbers.getRedNumTwo()));
			viewHoloder.previewViewHoloder.two_red_num_three_tv.setText(String.valueOf(unionLotteryNumbers.getRedNumThree()));
			viewHoloder.previewViewHoloder.two_red_num_four_tv.setText(String.valueOf(unionLotteryNumbers.getRedNumFour()));
	...
	private void setRedBallViewData(int position, UnionLotteryInfo unionLotteryInfo, ViewHoloder viewHoloder) {
		...
		if (redBallNumInfo != null) {
			...
			if (redBallNumInfo.getRedBallNum1() > 0 && isDataShow(redBallNumInfo.getRedBallNum1Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum1.setBackground(getNumberBg(redBallNumInfo.getRedBallNum1Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum2() > 0 && isDataShow(redBallNumInfo.getRedBallNum2Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum2.setBackground(getNumberBg(redBallNumInfo.getRedBallNum2Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum3() > 0 && isDataShow(redBallNumInfo.getRedBallNum3Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum3.setBackground(getNumberBg(redBallNumInfo.getRedBallNum3Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum4() > 0 && isDataShow(redBallNumInfo.getRedBallNum4Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum4.setBackground(getNumberBg(redBallNumInfo.getRedBallNum4Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum5() > 0 && isDataShow(redBallNumInfo.getRedBallNum5Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum5.setBackground(getNumberBg(redBallNumInfo.getRedBallNum5Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum6() > 0 && isDataShow(redBallNumInfo.getRedBallNum6Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum6.setBackground(getNumberBg(redBallNumInfo.getRedBallNum6Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum7() > 0 && isDataShow(redBallNumInfo.getRedBallNum7Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum7.setBackground(getNumberBg(redBallNumInfo.getRedBallNum7Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum8() > 0 && isDataShow(redBallNumInfo.getRedBallNum8Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum8.setBackground(getNumberBg(redBallNumInfo.getRedBallNum8Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum9() > 0 && isDataShow(redBallNumInfo.getRedBallNum9Type())) {
				...
				viewHoloder.unionRedViewHoloder.mUnionRedNum9.setBackground(getNumberBg(redBallNumInfo.getRedBallNum9Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum10() > 0 && isDataShow(redBallNumInfo.getRedBallNum10Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum10.setText(String.valueOf(redBallNumInfo.getRedBallNum10()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum10.setBackground(getNumberBg(redBallNumInfo.getRedBallNum10Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum11() > 0 && isDataShow(redBallNumInfo.getRedBallNum11Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum11.setText(String.valueOf(redBallNumInfo.getRedBallNum11()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum11.setBackground(getNumberBg(redBallNumInfo.getRedBallNum11Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum12() > 0 && isDataShow(redBallNumInfo.getRedBallNum12Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum12.setText(String.valueOf(redBallNumInfo.getRedBallNum12()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum12.setBackground(getNumberBg(redBallNumInfo.getRedBallNum12Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum13() > 0 && isDataShow(redBallNumInfo.getRedBallNum13Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum13.setText(String.valueOf(redBallNumInfo.getRedBallNum13()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum13.setBackground(getNumberBg(redBallNumInfo.getRedBallNum13Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum14() > 0 && isDataShow(redBallNumInfo.getRedBallNum14Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum14.setText(String.valueOf(redBallNumInfo.getRedBallNum14()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum14.setBackground(getNumberBg(redBallNumInfo.getRedBallNum14Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum15() > 0 && isDataShow(redBallNumInfo.getRedBallNum15Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum15.setText(String.valueOf(redBallNumInfo.getRedBallNum15()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum15.setBackground(getNumberBg(redBallNumInfo.getRedBallNum15Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum16() > 0 && isDataShow(redBallNumInfo.getRedBallNum16Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum16.setText(String.valueOf(redBallNumInfo.getRedBallNum16()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum16.setBackground(getNumberBg(redBallNumInfo.getRedBallNum16Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum17() > 0 && isDataShow(redBallNumInfo.getRedBallNum17Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum17.setText(String.valueOf(redBallNumInfo.getRedBallNum17()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum17.setBackground(getNumberBg(redBallNumInfo.getRedBallNum17Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum18() > 0 && isDataShow(redBallNumInfo.getRedBallNum18Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum18.setText(String.valueOf(redBallNumInfo.getRedBallNum18()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum18.setBackground(getNumberBg(redBallNumInfo.getRedBallNum18Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum19() > 0 && isDataShow(redBallNumInfo.getRedBallNum19Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum19.setText(String.valueOf(redBallNumInfo.getRedBallNum19()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum19.setBackground(getNumberBg(redBallNumInfo.getRedBallNum19Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum20() > 0 && isDataShow(redBallNumInfo.getRedBallNum20Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum20.setText(String.valueOf(redBallNumInfo.getRedBallNum20()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum20.setBackground(getNumberBg(redBallNumInfo.getRedBallNum20Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum21() > 0 && isDataShow(redBallNumInfo.getRedBallNum21Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum21.setText(String.valueOf(redBallNumInfo.getRedBallNum21()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum21.setBackground(getNumberBg(redBallNumInfo.getRedBallNum21Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum22() > 0 && isDataShow(redBallNumInfo.getRedBallNum22Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum22.setText(String.valueOf(redBallNumInfo.getRedBallNum22()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum22.setBackground(getNumberBg(redBallNumInfo.getRedBallNum22Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum23() > 0 && isDataShow(redBallNumInfo.getRedBallNum23Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum23.setText(String.valueOf(redBallNumInfo.getRedBallNum23()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum23.setBackground(getNumberBg(redBallNumInfo.getRedBallNum23Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum24() > 0 && isDataShow(redBallNumInfo.getRedBallNum24Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum24.setText(String.valueOf(redBallNumInfo.getRedBallNum24()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum24.setBackground(getNumberBg(redBallNumInfo.getRedBallNum24Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum25() > 0 && isDataShow(redBallNumInfo.getRedBallNum25Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum25.setText(String.valueOf(redBallNumInfo.getRedBallNum25()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum25.setBackground(getNumberBg(redBallNumInfo.getRedBallNum25Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum26() > 0 && isDataShow(redBallNumInfo.getRedBallNum26Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum26.setText(String.valueOf(redBallNumInfo.getRedBallNum26()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum26.setBackground(getNumberBg(redBallNumInfo.getRedBallNum26Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum27() > 0 && isDataShow(redBallNumInfo.getRedBallNum27Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum27.setText(String.valueOf(redBallNumInfo.getRedBallNum27()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum27.setBackground(getNumberBg(redBallNumInfo.getRedBallNum27Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum28() > 0 && isDataShow(redBallNumInfo.getRedBallNum28Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum28.setText(String.valueOf(redBallNumInfo.getRedBallNum28()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum28.setBackground(getNumberBg(redBallNumInfo.getRedBallNum28Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum29() > 0 && isDataShow(redBallNumInfo.getRedBallNum29Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum29.setText(String.valueOf(redBallNumInfo.getRedBallNum29()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum29.setBackground(getNumberBg(redBallNumInfo.getRedBallNum29Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum30() > 0 && isDataShow(redBallNumInfo.getRedBallNum30Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum30.setText(String.valueOf(redBallNumInfo.getRedBallNum30()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum30.setBackground(getNumberBg(redBallNumInfo.getRedBallNum30Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum31() > 0 && isDataShow(redBallNumInfo.getRedBallNum31Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum31.setText(String.valueOf(redBallNumInfo.getRedBallNum31()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum31.setBackground(getNumberBg(redBallNumInfo.getRedBallNum31Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum32() > 0 && isDataShow(redBallNumInfo.getRedBallNum32Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum32.setText(String.valueOf(redBallNumInfo.getRedBallNum32()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum32.setBackground(getNumberBg(redBallNumInfo.getRedBallNum32Type()));
			} else {
			...
			if (redBallNumInfo.getRedBallNum33() > 0 && isDataShow(redBallNumInfo.getRedBallNum33Type())) {
				viewHoloder.unionRedViewHoloder.mUnionRedNum33.setText(String.valueOf(redBallNumInfo.getRedBallNum33()));
				viewHoloder.unionRedViewHoloder.mUnionRedNum33.setBackground(getNumberBg(redBallNumInfo.getRedBallNum33Type()));
			} else {
	...
	private void setBlueBallViewData(int position, UnionLotteryInfo unionLotteryInfo, ViewHoloder viewHoloder) {
		...
		if (blueBallNumInfo != null) {
			if (blueBallNumInfo.getBlueBallNum1() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum1Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData1.setText(String.valueOf(blueBallNumInfo.getBlueBallNum1()));
				viewHoloder.blueNumForecastHolder.blueNumData1.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum1Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum2() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum2Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData2.setText(String.valueOf(blueBallNumInfo.getBlueBallNum2()));
				viewHoloder.blueNumForecastHolder.blueNumData2.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum2Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum3() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum3Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData3.setText(String.valueOf(blueBallNumInfo.getBlueBallNum3()));
				viewHoloder.blueNumForecastHolder.blueNumData3.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum3Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum4() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum4Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData4.setText(String.valueOf(blueBallNumInfo.getBlueBallNum4()));
				viewHoloder.blueNumForecastHolder.blueNumData4.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum4Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum5() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum5Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData5.setText(String.valueOf(blueBallNumInfo.getBlueBallNum5()));
				viewHoloder.blueNumForecastHolder.blueNumData5.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum5Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum6() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum6Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData6.setText(String.valueOf(blueBallNumInfo.getBlueBallNum6()));
				viewHoloder.blueNumForecastHolder.blueNumData6.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum6Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum7() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum7Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData7.setText(String.valueOf(blueBallNumInfo.getBlueBallNum7()));
				viewHoloder.blueNumForecastHolder.blueNumData7.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum7Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum8() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum8Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData8.setText(String.valueOf(blueBallNumInfo.getBlueBallNum8()));
				viewHoloder.blueNumForecastHolder.blueNumData8.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum8Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum9() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum9Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData9.setText(String.valueOf(blueBallNumInfo.getBlueBallNum9()));
				viewHoloder.blueNumForecastHolder.blueNumData9.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum9Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum10() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum10Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData10.setText(String.valueOf(blueBallNumInfo.getBlueBallNum10()));
				viewHoloder.blueNumForecastHolder.blueNumData10.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum10Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum11() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum11Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData11.setText(String.valueOf(blueBallNumInfo.getBlueBallNum11()));
				viewHoloder.blueNumForecastHolder.blueNumData11.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum11Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum12() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum12Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData12.setText(String.valueOf(blueBallNumInfo.getBlueBallNum12()));
				viewHoloder.blueNumForecastHolder.blueNumData12.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum12Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum13() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum13Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData13.setText(String.valueOf(blueBallNumInfo.getBlueBallNum13()));
				viewHoloder.blueNumForecastHolder.blueNumData13.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum13Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum14() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum14Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData14.setText(String.valueOf(blueBallNumInfo.getBlueBallNum14()));
				viewHoloder.blueNumForecastHolder.blueNumData14.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum14Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum15() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum15Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData15.setText(String.valueOf(blueBallNumInfo.getBlueBallNum15()));
				viewHoloder.blueNumForecastHolder.blueNumData15.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum15Type()));
			} else {
			...
			if (blueBallNumInfo.getBlueBallNum16() > 0 && isDataShow(blueBallNumInfo.getBlueBallNum16Type())) {
				viewHoloder.blueNumForecastHolder.blueNumData16.setText(String.valueOf(blueBallNumInfo.getBlueBallNum16()));
				viewHoloder.blueNumForecastHolder.blueNumData16.setBackground(getBlueNumberBg(blueBallNumInfo.getBlueBallNum16Type()));
			} else {
